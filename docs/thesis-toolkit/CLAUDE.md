...
**Pipeline status (2026-05-13):** Sprint 1-10 tamamlandi. Sprint 10 = TRUBA QA raporu duzeltmeleri (BUG-65..72): PFAZ13 path + metadata-aware CSV okuma, Job 3/4 exit code propagation, HPC_MODE worker limit (108 worker, eski 16), config data_file. Son patch: sprint10-qa-fixes.patch. v10 Sprint 10 sync bekliyor (BUG-65..72 sadece hpcv1'de). TRUBA dosya transferi patch uygulandiktan sonra yapilmali.
